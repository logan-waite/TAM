            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        <li id='time_clock' <?=$tc_active?>><a href="../time_clock/time_clock.php">Time Clock</a></li>
                        <li id='clients_projects'<?=$cp_active?>><a href="../clients_projects/clients_projects.php">Clients and Projects</a></li>
                        <li id='billing'<?=$b_active?>><a href="../billing/billing.php">Billing</a></li>
                    </ul>
